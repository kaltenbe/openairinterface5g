...
static void get_channel_model_mode() {
  ...
  int num_n1_antennas = *GNBParams[GNB_PDSCH_ANTENNAPORTS_N1_IDX].iptr;
  int num_ul_antennas = *GNBParams[GNB_PUSCH_ANTENNAPORTS_IDX].iptr;

  if (num_n1_antennas == 2 && num_ul_antennas == 2)
