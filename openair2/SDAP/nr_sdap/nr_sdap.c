...
void sdap_data_ind(rb_id_t pdcp_entity,
  ...
  LATSEQ_P("U sdap.pdu--sdap.sdu", "len%d:rnti%d:pdusession_id%d.rb_id%d.sdap_default_drb%d.bufaddress%016llx", size, rnti, pdusession_id, pdcp_entity, sdap_entity->default_drb, buf);
